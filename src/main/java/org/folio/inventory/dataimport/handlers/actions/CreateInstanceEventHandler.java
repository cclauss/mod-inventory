...
public class CreateInstanceEventHandler extends AbstractInstanceEventHandler {
  ...
  public CompletableFuture<DataImportEventPayload> handle(DataImportEventPayload dataImportEventPayload) {
    ...
    try {
      ...
      LOGGER.error("In Handle this JSON-Instance: "+ instanceAsJson);
      ...
      if (errors.isEmpty()) {
        ...
        LOGGER.error("Before addInstance: "+ mappedInstance.getInstanceTypeId());
  ...
  private Future<Instance> addInstance(Instance instance, InstanceCollection instanceCollection) {
    ...
    LOGGER.error("In addInstance method we have this instanceType: "+  instance.getInstanceTypeId());
